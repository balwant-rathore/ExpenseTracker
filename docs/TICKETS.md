...
| ET002   | Domain model, entities, enums, EF configurations, DbContext, repositories, SQL Server schema, attachment model, seed CSV import | 2, 4, 5, 6, 11, 14 | Domain   | In progress | Core database | et002-domain-setup |
