...
| ET003   | Authentication infrastructure, JWT, refresh tokens, BCrypt, authorization policies, middleware, rate limiting  | 3   | Authentication | In progress | Security foundation | et003-auth-foundation |
