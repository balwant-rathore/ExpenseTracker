...
| ET020   | Unit tests, integration tests, Playwright E2E, FRS traceability matrix, CI quality gates, release readiness  | All  | Quality  | In progress | Verification  | et020-quality-release |
