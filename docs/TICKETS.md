...
| ET005   | Forgot password, OTP lifecycle, reset password, refresh token revocation, Scalar OpenAPI UI integration (ADR-0004) | 3.4–3.5  | Authentication | PR open (#5) | [#5](https://github.com/balwant-rathore/ExpenseTracker/pull/5) | et005-auth-refresh |
