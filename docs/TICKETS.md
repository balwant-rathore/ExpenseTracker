...
| ET003   | Authentication infrastructure, JWT, refresh tokens, BCrypt, authorization policies, middleware, rate limiting  | 3   | Authentication | PR open (#3) | [#3](https://github.com/balwant-rathore/ExpenseTracker/pull/3) | et003-auth-foundation |
